        ...
        <div className="relative h-10 mb-6 -mt-2 overflow-visible">
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[520px] h-[520px] pointer-events-none hidden lg:block">
            ...
            <motion.div
              ...
              animate={{ rotate: 360 }}
              transition={{ duration: 26, repeat: Infinity, ease: [0, 0, 1, 1] }}
            >
        ...
        <div className="flex justify-center mt-8">
          ...
          >
            ...
            <motion.span
              ...
              initial={{ x: -100 }}
              animate={{ x: 140 }}
              transition={{ repeat: Infinity, duration: 2.2, ease: [0, 0, 1, 1] }}
...
const AnimatedCard: React.FC<{ item: Testimonial }> = ({ item }) => {
  ...
  const mask = useTransform([sx, sy], ([x, y]) => `radial-gradient(180px 180px at ${x}px ${y}px, rgba(34,211,238,0.25), transparent 60%)`);
  ...
  return (
    ...
    >
      ...
      <motion.span
        ...
        transition={{ duration: 6, repeat: Infinity, ease: [0, 0, 1, 1] }}
        style={{ backgroundImage: "linear-gradient(120deg, rgba(255,255,255,0.2), transparent 30%, transparent 70%, rgba(255,255,255,0.2))", backgroundSize: "200% 200%" }}
      />
      ...
      <div className="relative h-full p-6 bg-white/10 text-white rounded-2xl border border-white/20 shadow-2xl backdrop-blur-md overflow-hidden">
        ...
        <motion.div
          ...
          className="absolute inset-0"
          animate={{ y: [0, -4, 0] }}
          transition={{ duration: 7, repeat: Infinity, ease: [0.42, 0, 0.58, 1], delay: Math.random() * 1.5 }}
        />
        {/* cursor glow mask */}
        <motion.span
          aria-hidden
        ...
        <p className="text-slate-300 italic mb-4 mt-1">
          “{item.text}”
        </p>
...
if (typeof window !== "undefined" && process.env.NODE_ENV !== "production") {
  ...
  const __icons = [CalendarCheck, Users, Eye, RefreshCw, Shield, ServerCog, BarChart3, Plug, MessageSquare, PhoneCall, FileText, FileCog, FileSearch, Boxes, Megaphone, Globe];
