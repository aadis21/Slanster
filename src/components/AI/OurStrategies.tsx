...
const OurStrategies = () => {
  return (
    <div className="w-full min-h-screen md:py-12 py-6 md:px-0 px-4 bg-white flex flex-col items-center">
      {/* Tag */}
      <div className="mb-4">
        <span
      ...
      {/* Strategy Cards */}
      <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-6xl">
